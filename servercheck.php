...
<body>
	...
	<footer>
		<div class="footer">
			<a href="#">Server Check PHP</a> v <?php echo $server_check_version; ?> | 
			Built by <a href="https://ridhohafidz.com/">RidhoHafidz</a> | 🌙 <a href="javascript:void(0)" onclick="toggleDarkMode();">Dark Mode</a>
		</div>
	</footer>
<script>
